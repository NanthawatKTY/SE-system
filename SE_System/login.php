...
<html lang="en">
  ...
  <body> <center>  
  <form  name="login" method = "POST" action = "check_login.php" class="form-signin col-3 mt-5">
  <img class="mb-4" src="../testt/128x128.png" alt="" width="200" height="200">
  <h1 class="h3 mb-3 font-weight-normal"><font size="10" color="white">Please sign in</font></h1>
